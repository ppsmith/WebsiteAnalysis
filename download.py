...
# contains methods to download html of known web pages, or a specific webpage

# func. downloads the data for all links in the dictionary. path is the path for the dictionary, and the dirtyRoot is
# the file for the dirty data. From seed is an option. 1 if the dict is emtpy, 0 if the dict has entries
